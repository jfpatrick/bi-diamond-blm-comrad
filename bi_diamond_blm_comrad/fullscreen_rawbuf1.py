    ...
    def updateFlags_1_2(self, state):
        ...
        if state == Qt.Checked:
            ...
            if self.current_flags_dict["1,2"]:
                self.CStaticPlot_Capture_rawBuf1.addItem(self.CURVE_pydm_channel_capture_rawbuffer_1_flags_1_2)
            ...
            self.CStaticPlot_Capture_rawBuf1.removeItem(self.CURVE_pydm_channel_capture_rawbuffer_1_flags_1_2)
            self.pydm_channel_capture_rawbuffer_1_flags_1_2.context_changed()
            self.pydm_channel_capture_rawbuffer_1_timestamps.context_changed()
            self.pydm_channel_capture_rawbuffer_1.context_changed()
