...
class MyDisplay(CDisplay):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.pydm_channel_capture_rawbuffer_0_flags2 = PyDMChannelDataSource(channel_address="rda3://UCAP-NODE-BI-DIAMOND-BLM/UCAP.VD." + self.diamond_blm_device_list[0] + "/" + "bufferFFT#flags0_two", data_type_to_emit=CurveData, parent=self.CStaticPlot_Capture_rawBuf0)
    ...
    def updateFlags1(self, state):
        ...
        if state == Qt.Checked:
            ...
            if self.current_flags_dict["1"]:
                self.CStaticPlot_Capture_rawBuf0.addItem(self.CURVE_pydm_channel_capture_rawbuffer_0_flags1)
            if self.current_flags_dict["2"]:
                self.CStaticPlot_Capture_rawBuf0.addItem(self.CURVE_pydm_channel_capture_rawbuffer_0_flags2)
            if self.current_flags_dict["5"]:
                self.CStaticPlot_Capture_rawBuf0.addItem(self.CURVE_pydm_channel_capture_rawbuffer_0_timestamps_five)
            if self.current_flags_dict["6"]:
                self.CStaticPlot_Capture_rawBuf0.addItem(self.CURVE_pydm_channel_capture_rawbuffer_0_timestamps_six)
            ...
            self.pydm_channel_capture_rawbuffer_0_flags2.context_changed()
            ...
            self.CStaticPlot_Capture_rawBuf0.removeItem(self.CURVE_pydm_channel_capture_rawbuffer_0_flags1)
            self.pydm_channel_capture_rawbuffer_0_flags1.context_changed()
            self.pydm_channel_capture_rawbuffer_0_flags2.context_changed()
            self.pydm_channel_capture_rawbuffer_0_timestamps_five.context_changed()
            self.pydm_channel_capture_rawbuffer_0_timestamps_six.context_changed()
    ...
    def updateFlags2(self, state):
        ...
        if state == Qt.Checked:
            ...
            self.CStaticPlot_Capture_rawBuf0.removeItem(self.CURVE_pydm_channel_capture_rawbuffer_0_flags2)
            self.pydm_channel_capture_rawbuffer_0_flags1.context_changed()
            self.pydm_channel_capture_rawbuffer_0_flags2.context_changed()
            self.pydm_channel_capture_rawbuffer_0_timestamps_five.context_changed()
            self.pydm_channel_capture_rawbuffer_0_timestamps_six.context_changed()
    ...
    def updateFlags5(self, state):
        ...
        if state == Qt.Checked:
            ...
            self.CStaticPlot_Capture_rawBuf0.removeItem(self.CURVE_pydm_channel_capture_rawbuffer_0_timestamps_five)
            self.pydm_channel_capture_rawbuffer_0_flags1.context_changed()
            self.pydm_channel_capture_rawbuffer_0_flags2.context_changed()
            self.pydm_channel_capture_rawbuffer_0_timestamps_five.context_changed()
            self.pydm_channel_capture_rawbuffer_0_timestamps_six.context_changed()
    ...
    def updateFlags6(self, state):
        ...
        if state == Qt.Checked:
            ...
            self.CStaticPlot_Capture_rawBuf0.removeItem(self.CURVE_pydm_channel_capture_rawbuffer_0_timestamps_six)
            self.pydm_channel_capture_rawbuffer_0_flags1.context_changed()
            self.pydm_channel_capture_rawbuffer_0_flags2.context_changed()
            self.pydm_channel_capture_rawbuffer_0_timestamps_five.context_changed()
            self.pydm_channel_capture_rawbuffer_0_timestamps_six.context_changed()
    ...
    def setChannels(self):
        ...
        self.CStaticPlot_Capture_rawBuf0.clear_items()
        self.CURVE_pydm_channel_capture_rawbuffer_0_flags1 = self.CStaticPlot_Capture_rawBuf0.addCurve(data_source=self.pydm_channel_capture_rawbuffer_0_flags1, color=QColor("#06D6A0"))
        self.CURVE_pydm_channel_capture_rawbuffer_0_flags2 = self.CStaticPlot_Capture_rawBuf0.addCurve(data_source=self.pydm_channel_capture_rawbuffer_0_flags2, color=QColor("#EF476F"))
        self.CURVE_pydm_channel_capture_rawbuffer_0_timestamps_five = self.CStaticPlot_Capture_rawBuf0.addTimestampMarker(data_source = self.pydm_channel_capture_rawbuffer_0_timestamps_five)
        self.CURVE_pydm_channel_capture_rawbuffer_0_timestamps_six = self.CStaticPlot_Capture_rawBuf0.addTimestampMarker(data_source = self.pydm_channel_capture_rawbuffer_0_timestamps_six)
